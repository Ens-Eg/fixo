            ...
            <section>
              ...
              <div className="space-y-8">
                {[
                  ...
                  <div
                    key={sectionKey}
                    className="bg-gray-50/50 dark:bg-gray-900/30 rounded-lg p-6 border border-gray-200/50 dark:border-gray-800/50"
                  >
                    ...
                    <div className="text-gray-700 dark:text-gray-300 leading-relaxed space-y-3">
                      {(() => {
                        try {
                          const content = t.raw(
                            `terms.sections.${sectionKey}.content`,
                          );
                          ...
                          return (
                            <p>{t(`terms.sections.${sectionKey}.content`)}</p>
                          );
                        } catch {
                          return (
                            <p>{t(`terms.sections.${sectionKey}.content`)}</p>
