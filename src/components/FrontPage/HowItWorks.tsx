          ...
          {steps.map((step, idx) => (
            ...
            >
              ...
              <div className="relative z-10">
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-r from-purple-600 to-purple-700 dark:from-purple-500 dark:to-purple-600 flex items-center justify-center text-white mb-6 shadow-xl">
