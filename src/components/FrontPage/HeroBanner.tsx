...
const InteractivePhone = () => {
  ...
  const menuItems = [
    {
      name: isRTL ? "كابتشينو إيطالي" : "Italian Cappuccino",
      price: "25",
      image:
        "/images/products/one.jpg",
      desc: isRTL ? "رغوة غنية وحبوب مختارة" : "Rich foam and selected beans",
      category: "drinks",
    },
    {
      name: isRTL ? "كرواسون زبدة" : "Butter Croissant",
      price: "12",
      image:
        "/images/products/two.jpg",
      desc: isRTL ? "مخبوز طازج يومياً" : "Freshly baked daily",
      category: "bakery",
    },
    {
      name: isRTL ? "تشيز كيك فراولة" : "Strawberry Cheesecake",
      price: "28",
      image:
        "/images/products/three.jpg",
      desc: isRTL ? "كريمة غنية مع صوص فراولة" : "Rich cream with strawberry sauce",
      category: "desserts",
    },
    {
      name: isRTL ? "بيتزا مارغريتا" : "Margherita Pizza",
      price: "35",
      image:
        "/images/products/four.jpg",
      desc: isRTL ? "عجينة إيطالية تقليدية" : "Traditional Italian dough",
      category: "food",
    },
    {
      name: isRTL ? "عصير برتقال طازج" : "Fresh Orange Juice",
      price: "18",
      image:
        "/images/products/five.jpg",
      desc: isRTL ? "برتقال طبيعي 100%" : "100% natural orange",
      category: "drinks",
    },
  ];
          ...
          {step === 0 && (
            ...
            >
              ...
              <p className="text-purple-700 font-bold text-lg text-center leading-relaxed">
                {isRTL ? "قم بمسح الرمز لتصفح المنيو" : "Scan code to browse menu"}
              </p>
            </div>
          )}
          {step === 1 && (
            ...
            >
              <div className="w-full aspect-square border-2 border-white/20 rounded-[40px] flex items-center justify-center overflow-hidden relative">
                <QrCode size={140} className="text-white/40" />
              ...
              <p className="mt-8 text-white text-lg font-medium tracking-wide">
                {isRTL ? "جاري مسح المنيو الالكتروني..." : "Scanning the electronic menu..."}
              </p>
            </div>
          )}
          {step === 2 && (
            <div
              ...
              dir={isRTL ? "rtl" : "ltr"}
            >
              <div className="p-7 pt-10 bg-gradient-to-br from-purple-600 to-indigo-700 text-white rounded-b-[40px] shadow-lg">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          >
            ...
            <h1 className="text-5xl lg:text-7xl font-extrabold leading-[1.1] mb-8 text-slate-900 dark:text-white">
              {t("title1")}{" "}
            ...
            >
              <div>
                <Link
                  ...
                  className="px-10 py-5 rounded-full bg-gradient-to-r from-purple-600 to-purple-700 dark:from-purple-500 dark:to-purple-600 text-white font-bold text-md shadow-2xl shadow-purple-200 dark:shadow-purple-900/50 flex items-center gap-3"
                >
                  <span>{t("cta")}</span>
                  <ArrowIcon size={24} />
                </Link>
          ...
          <div
            className="lg:w-1/2 relative flex justify-center order-1 "
          >
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-purple-600 to-purple-700 dark:from-purple-500 dark:to-purple-600 blur-[100px] opacity-15 dark:opacity-25" />
              <InteractivePhone />
            </div>
          </div>
        </div>
