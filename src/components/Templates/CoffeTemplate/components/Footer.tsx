...
const Footer = ({
  ...
  return (
    <footer className="bg-[#221D1A] border-t border-[#3B332E]">
              ...
              <div className="flex gap-4">
                {socialLinks.map((link) => (
                  <a
                    ...
                    className="w-10 h-10 rounded-full bg-[#3B332E] flex items-center justify-center hover:bg-[#F2B705] hover:text-[#17120F] transition-colors text-[#B6AA99]"
