...
export default function Footer({
    ...
    const footerDescription = isArabic ? footerDescriptionAr : footerDescriptionEn;
    ...
    return (
        <footer className="py-16 bg-gradient-to-b from-[var(--bg-main)]/10 to-white border-t border-[var(--border-main)]/10">
